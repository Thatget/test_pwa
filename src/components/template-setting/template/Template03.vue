            ...
            <div class="px-4 mx-auto" style="max-width: 100%; padding-bottom: 30px; margin-top: 30px;">
              <div class="d-flex flex-column flex-sm-row">
                ...
                <div class="col-12 col-sm-8 d-flex flex-column">
                  <div :style="`font-size: ${settings.category_font_size}px; font-weight: ${settings.category_font_weight}; text-transform: ${settings.category_text_style}; text-align: ${settings.category_text_align}; color: ${settings.category_font_color}; font-family: ${settings.category_font_family}; padding-bottom: 10px`">Plancing an Order</div>
                  <div class="accordion" >
