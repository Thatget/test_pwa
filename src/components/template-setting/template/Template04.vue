                    ...
                    <div class="p-4">
                      ...
                      <div class="tab-content mt-3" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="categoryid" role="tabpanel" aria-labelledby="category">
                          <div class="pt-2">
                            <span>Category bar active color</span>
            ...
            <div class="px-4 mx-auto" style="max-width: 100%;">
              <div class="d-flex flex-column flex-sm-row">
                <div class="col-12 col-sm-4">
                  <div class="">
                    <div class="category-nav d-flex flex-row flex-sm-column justify-content-center" :style="`margin: calc(${settings.category_font_size}px*1.8  + 70px + (${settings.faq_font_size}px*.4 - 16px*.4 + 1px)) 30px 30px 0;`">
                      <div class="fs-6" style="padding: 0 10px; cursor: pointer; margin-bottom: 16px" :style="`font-family: ${settings.category_font_family};color: ${settings.category_bar_background}; text-transform: ${settings.category_text_style}`">
                        <a href="#category-bar-config" :style="`text-decoration: none; color: ${settings.category_bar_background};`">
                          <span style="padding-bottom: 4px" :style="`border-bottom: 1px solid ${settings.category_bar_background}`">Plancing an Order</span>
                        </a>
                      </div>
                      <div class="fs-6" style="padding: 0 10px; cursor: pointer" :style="`font-family: ${settings.category_font_family};color: ${settings.category_bar_color}; text-transform: ${settings.category_text_style}`">
                        <a href="#category-bar-config" :style="`text-decoration: none; color: ${settings.category_bar_color};`">
                          <span style="padding-bottom: 4px">Refunds</span>                        
                        </a>
                      </div>
                    </div>
                  </div>
                ...
                <div class="col-12 col-sm-8 d-flex flex-column">
                  <div :style="`font-size: ${settings.category_font_size}px; font-weight: ${settings.category_font_weight}; text-transform: ${settings.category_text_style}; text-align: ${settings.category_text_align}; font-family: ${settings.category_font_family}; padding-bottom: 40px; margin-top: 30px`">
                  ...
                  <div class="accordion" >
                    <div style="color: red !important; margin-bottom: 20px">
                      <div  :style="`font-size: ${settings.faq_font_size}px;`">
                        <a class="text-break d-flex align-items-start" href="#category-bar-config" :style="`text-decoration: none; color: ${settings.faq_font_color}`">
                          <i class="fa-solid fa-angle-right" :style="`font-size: ${settings.faq_font_size}px; height: ${settings.faq_font_size}px; width: ${settings.faq_font_size}px; margin-top: calc(${settings.faq_font_size}px * 0.4)`"></i>
                          <span :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}; margin-left: 20px`">When will I be charged for my order?</span>
                        </a>
                      </div>
                    </div>
                    <div style="margin-bottom: 20px">
                      <div :class="`text-break d-flex align-items-start`" :style="`font-size: ${settings.faq_font_size}px; color: ${settings.faq_font_color}`">
                        <a class="text-break d-flex align-items-start" href="#category-bar-config" :style="`text-decoration: none; color: ${settings.faq_font_color}`">
                          <i class="fa-solid fa-angle-down" :style="`font-size: ${settings.faq_font_size}px; height: ${settings.faq_font_size}px; width: ${settings.faq_font_size}px; margin-top: calc(${settings.faq_font_size}px * 0.4)`"></i>
                          <span :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}; margin-left: 20px`">How do I redeem my One 4 All card?</span>                        
                        </a>
                      </div>
                      <div :style="`margin-left: calc(${settings.faq_font_size}px + 20px)`">
