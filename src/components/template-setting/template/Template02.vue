            ...
            <div class="m-auto" style="max-width: 800px">
              <div class="" style="padding: 30px 16px">
                ...
                <div class="px-3 d-flex flex-column">
                  <div>
                    <div v-if="!settingsOrigin.dont_category_faq" class="" :style="`font-size: ${settings.category_font_size}px; font-weight: ${settings.category_font_weight}; text-transform: ${settings.category_text_style}; text-align: ${settings.category_text_align}; color: ${settings.category_font_color}; font-family: ${settings.category_font_family}; padding: 10px 0 4px 0`">Plancing an Order</div>
                    <div class="accordion" >
                      <div class="accordion-item rounded" style="border: none !important; margin-bottom: 12px">
                        <h2 class="accordion-header" style="cursor: pointer">
                        <div @mousemove="chgBgColor = true" @mouseleave="chgBgColor = false" :class="`text-break d-flex justify-content-between rounded align-items-center`" style="padding: 12px; line-height: 1.8;" :style="chgBgColor === true? `background-color: ${settings.faq_hover_color}; font-size: ${settings.faq_font_size}px` : `background-color: ${settings.faq_bg_color}; font-size: ${settings.faq_font_size}px`">
                          <div :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}`">When will I be charged for my order?</div>
                          <i :style="`color: ${settings.faq_font_color};`" class="fas fa-angle-right"></i>
                        </div>
                        </h2>
                      </div>
                      <div class="accordion-item rounded" style="border: none !important; margin-bottom: 12px">
                        <h2 class="accordion-header" style="cursor: pointer;">
                          <div @mousemove="chgBgColor1 = true" @mouseleave="chgBgColor1 = false" :class="`text-break d-flex justify-content-between align-items-center text-white collapse show`" style="padding: 12px; line-height: 1.8; border-radius: 4px 4px 0 0;" :style="chgBgColor1 === true? `background-color: ${settings.faq_hover_color}; font-size: ${settings.faq_font_size}px` : `background-color: ${settings.faq_bg_color}; font-size: ${settings.faq_font_size}px;`">
                            <div :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}`">How do I redeem my One 4 All card?</div>
                            <i :style="`color: ${settings.faq_font_color};`" class="fas fa-angle-down"></i>
                          </div>
                        </h2>
                        <div class="accordion-collapse collapsed">
                          <div class="accordion-body text-start text-break" :style="`background-color: ${settings.answer_bg_color}`">
                            <div :style="`font-weight: ${settings.answer_font_weight}; font-size: ${settings.answer_font_size}px; color: ${settings.answer_font_color}; font-family: ${settings.answer_font_family}`">We are currently accepting One 4 All cards instore only. Please retain your card after making your purchase, as should you wish to return any items bought using a One 4 All card, we will use this payment method to refund you.</div>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <div>
                    <div v-if="!settingsOrigin.dont_category_faq" class="" :style="`font-size: ${settings.category_font_size}px; font-weight: ${settings.category_font_weight}; text-transform: ${settings.category_text_style}; text-align: ${settings.category_text_align}; color: ${settings.category_font_color}; font-family: ${settings.category_font_family}; padding: 10px 0 4px 0`">Refunds</div>
                    <div class="accordion" >
                      <div class="accordion-item rounded" style="border: none !important; margin-bottom: 12px">
                        <h2 class="accordion-header" style="cursor: pointer">
                        <div @mousemove="chgBgColor2 = true" @mouseleave="chgBgColor2 = false" :class="`text-break d-flex rounded justify-content-between align-items-center`" style="padding: 12px; line-height: 1.8;" :style="chgBgColor2 === true? `background-color: ${settings.faq_hover_color}; font-size: ${settings.faq_font_size}px` : `background-color: ${settings.faq_bg_color}; font-size: ${settings.faq_font_size}px`">
                          <div :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}`">I have returned my order – will you refund my delivery?</div>
                          <i :style="`color: ${settings.faq_font_color};`" class="fas fa-angle-right"></i>
                        </div>
                        </h2>
                      </div>
...
<script>
  ...
  export default {
    ...
    setup(props, { emit }){
      ...
      const chgBgColor = ref()
      const chgBgColor1 = ref()
      const chgBgColor2 = ref()
      // const changeBtnColor = ref()
