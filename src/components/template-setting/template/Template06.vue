                    ...
                    <div class="p-4">
                      ...
                      <div class="tab-content mt-3" id="nav-tabContent">
                        <div class="tab-pane fade show active" id="categoryid" role="tabpanel" aria-labelledby="category">
                          <div class="pt-2">
                            <span>Category bar active background color</span>
          ...
          <div class="m-4 border" :style="`background-color: ${settings.page_background_color}`">
            <div class="" v-if="settings.banner_visible">
              <div class="d-flex flex-column justify-content-between bg-light" :style="settings.image_banner? `background-image: url(${backendLink}/var/images/banner/${settings.image_banner}); background-size: cover; background-position: center; min-height: calc(${settings.banner_height}px)` : `background-image: url(${backendLink}/var/images/banner/${settings.banner_default}); background-size: cover; background-position: center;min-height: calc(${settings.banner_height}px)`">
                ...
                <div class="col-12">
                  <div class="">
                    <div class="category-nav d-flex justify-content-center">
                      <div class="fs-6" style="padding: 10px 16px; cursor: pointer" :style="`font-family: ${settings.category_font_family};color: ${settings.category_bar_color}; text-transform: ${settings.category_text_style}`">
                        <a href="#category-bar-config" :style="`text-decoration: none; color: ${settings.category_bar_color};`">
                          <span>Account</span>                        
                        </a>
                      </div>
                      <div class="fs-6" style="padding: 10px 16px; cursor: pointer; border-radius: 4px 4px 0 0" :style="`font-family: ${settings.category_font_family};background-color: ${settings.category_bar_background}; text-transform: ${settings.category_text_style}`">
                        <a href="#category-bar-config" :style="`text-decoration: none;color: ${settings.category_bar_color};`">
                          <span>Plancing an Order</span>
                        </a>
                      </div>
                      <div class="fs-6" style="padding: 10px 16px; cursor: pointer" :style="`font-family: ${settings.category_font_family};color: ${settings.category_bar_color}; text-transform: ${settings.category_text_style}`">
                        <a href="#category-bar-config" :style="`text-decoration: none; color: ${settings.category_bar_color};`">
            ...
            <div v-else>
              <div class="d-flex flex-column justify-content-between" :style="`min-height: ${settings.banner_height}px; background-color: ${settings.faq_hover_color}`">
                <div>
                  <div v-if="settingsOrigin.show_page_title" class="text-center" :style="`padding-top: ${settings.page_title_paddingtop}px; padding-bottom: ${settings.page_title_paddingbottom}px; color: ${settings.page_title_color}; font-family: ${settings.page_title_font}`">
            ...
            <div class="px-4 col-12 col-lg-10 mx-auto" style="max-width: 100%;">
              <div class="">
                <div class="col-12 d-flex flex-column">
                  <div :style="`font-size: ${settings.category_font_size}px; font-weight: ${settings.category_font_weight}; text-transform: ${settings.category_text_style}; text-align: ${settings.category_text_align}; font-family: ${settings.category_font_family}; padding-bottom: 30px; margin-top: 30px`">
                    <a href="#category-bar-config" :style="`color: ${settings.category_font_color}; text-decoration: none`">Plancing an Order</a>
                  </div>
                  <div class="accordion" >
                    <div style="color: red !important; margin-bottom: 20px">
                      <div  :style="`font-size: ${settings.faq_font_size}px;`">
                        <a class="text-break d-flex align-items-start" href="#category-bar-config" :style="`text-decoration: none; color: ${settings.faq_font_color}`">
                          <i class="fa-solid fa-plus" :style="`font-size: calc(${settings.faq_font_size}px * 0.65); height: ${settings.faq_font_size}px; width: ${settings.faq_font_size}px; margin-top: calc(${settings.faq_font_size}px * 0.65)`"></i>
                          <span :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}; margin-left: 16px`">When will I be charged for my order?</span>
                        </a>
                      </div>
                    </div>
                    <div style="margin-bottom: 20px">
                      <div :class="`text-break d-flex align-items-start`" :style="`font-size: ${settings.faq_font_size}px; color: ${settings.faq_font_color}`">
                        <a class="text-break d-flex align-items-start" href="#category-bar-config" :style="`text-decoration: none; color: ${settings.faq_font_color}`">
                          <i class="fa-solid fa-minus" :style="`font-size: calc(${settings.faq_font_size}px * 0.65); height: ${settings.faq_font_size}px; width: ${settings.faq_font_size}px; margin-top: calc(${settings.faq_font_size}px * 0.65)`"></i>
                          <span :style="`color: ${settings.faq_font_color}; font-family: ${settings.faq_font_family}; font-weight: ${settings.faq_font_weight}; margin-left: 16px`">How do I redeem my One 4 All card?</span>                        
                        </a>
                      </div>
                      <div :style="`padding: 4px 10px 4px calc(${settings.faq_font_size}px + 16px)`">
                        <div class="text-start text-break" :style="`background-color: ${settings.answer_bg_color}`">
                          <a class="text-break d-flex align-items-start" href="#category-bar-config" :style="`text-decoration: none; color: ${settings.answer_font_color}`">
                            <span :style="`font-weight: ${settings.answer_font_weight}; font-size: ${settings.answer_font_size}px; color: ${settings.answer_font_color}; font-family: ${settings.answer_font_family}`">
